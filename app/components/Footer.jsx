...
const Footer = () => {
    return (
        <section className="py-10 bg-black text-white sm:pt-16 lg:pt-24 rounded-t-[3rem]">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        {/* <Image className="w-auto h-9" src="https://cdn.rareblocks.xyz/collection/celebration/images/logo.svg" alt="" width={1000} height={1000} /> */}
                        <div className="text-3xl sm:text-3xl flex  font-bold md:px-20 pb-2 text-gradient bg-gradient-to-r from-orange-500 to-green-300 bg-clip-text text-transparent">
                            e-VoteIndia
                        </div>

                        <p className="text-base leading-relaxed text-gray-600 mt-7">Empowering democracy 
                        <br/>with secure and transparent voting</p>
                    ...
                    <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                        ...
                        <form action="#" method="POST" className="mt-6">
                            <div>
                                <label for="tel" className="sr-only">Phone No.</label>
                                <input type="tel" name="tel" id="tel" placeholder="Enter your Phone No." className="block w-full p-4 text-white placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                            </div>
                ...
                <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by Govt. Of India</p>
            </div>
        </section>
